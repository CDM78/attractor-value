  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <Section id="layer-1" title="Layer 1: Quantitative Screen \u2014 Is This Stock Cheap Enough?">
        ...
        <p>Even if a stock passes P/E and P/B individually, this combined test ensures both aren't elevated at the same time.</p>
        <TechnicalDetails>
          <p className="font-mono">Pass condition: P/E \u00D7 P/B \u2264 22.5</p>
        </TechnicalDetails>
        ...
        <TechnicalDetails>
          <p className="font-mono">Pass condition: Current ratio \u2265 1.5</p>
        </TechnicalDetails>
        ...
        <div className="overflow-x-auto">
          <table className="text-sm w-full">
            ...
            <tbody>
              ...
              <tr className="border-b border-border/50"><td className="py-2 pr-4 font-bold text-warn">BUY*</td><td className="py-2">7/8 filters, price below buy-below, attractor confirmed, AI recommends proceeding</td></tr>
              ...
              <tr className="border-b border-border/50"><td className="py-2 pr-4 font-bold text-fail">OVER</td><td className="py-2">Overvalued. Don't buy. If held, consider selling.</td></tr>
              <tr className="border-b border-border/50"><td className="py-2 pr-4 font-bold text-warn">REVIEW</td><td className="py-2">Near miss stock that needs manual evaluation</td></tr>
              <tr><td className="py-2 pr-4 font-bold text-fail">DNB</td><td className="py-2">Attractor score below 2.0. Business model is dissolving. Do not buy.</td></tr>
            </tbody>
          </table>
        </div>
      </Section>
...
const GLOSSARY = [
  ...
  { term: 'Current Ratio', def: 'Current assets \u00F7 current liabilities. Measures ability to pay short-term obligations. Framework requires \u2265 1.5.' },
