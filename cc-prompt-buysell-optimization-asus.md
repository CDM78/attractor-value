...
5. Write a resume file: `cm/attractor-value/data/optimization-resume-state.json` containing:
...
1. Check for `cm/attractor-value/data/optimization-resume-state.json`
...
All work in: cm/attractor-value/
- Scripts: cm/attractor-value/scripts/
- Data: cm/attractor-value/data/prompt-optimization/
- Results: cm/attractor-value/results/
- Resume state: cm/attractor-value/data/optimization-resume-state.json
...
Save case list as `cm/attractor-value/data/prompt-optimization/case-list-200.json`.

### 0B: Pull ALL Required Data Per Case

For each of the 200 cases, collect and save to `cm/attractor-value/data/prompt-optimization/cases/CASE-XXXX.json`:
...
Split the complete cases into three FIXED partitions. Save the partition assignments to `cm/attractor-value/data/prompt-optimization/partitions.json`. Once assigned, NEVER change them.
...
- `cm/attractor-value/data/prompt-optimization/training-cases.json` (with outcomes)
- `cm/attractor-value/data/prompt-optimization/validation-cases.json` (with outcomes — but CC should only compute aggregates)
- `cm/attractor-value/data/prompt-optimization/holdout-case-ids.json` (IDs ONLY — no outcomes until Phase 4)
...
Save to `cm/attractor-value/data/prompt-optimization/round1-results.json`.
...
Save as `cm/attractor-value/results/prompt-optimization-final-report-2026-03-25.md`.
...
After each session, update `cm/attractor-value/data/prompt-optimization/progress-log.md`:
